/**
 * Dutch (nl) strings for the `umbraDesktopEntertainment` area. Same keys as `en.ts`, same reasons.
 *
...
export default {
  umbraDesktopEntertainment: {
    ...
    minesweeperElapsed: 'Seconden verstreken',
    minesweeperBoard: 'Mijnenveld',
    minesweeperWon: 'Geveegd.',
    minesweeperLost: 'Boem.',
    minesweeperClosed: 'gesloten',
