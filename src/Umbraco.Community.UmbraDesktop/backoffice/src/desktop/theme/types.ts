...
export const UMBRADESKTOP_TOKENS = [
  ...
  '--umbradesktop-snap-ghost-background',
  '--umbradesktop-snap-ghost-border',
  '--umbradesktop-snap-ghost-radius',
  ...
  '--umbradesktop-taskbar-divider-display',
  '--umbradesktop-taskbar-divider',
  '--umbradesktop-taskbar-divider-height',
  '--umbradesktop-taskbar-divider-opacity',
