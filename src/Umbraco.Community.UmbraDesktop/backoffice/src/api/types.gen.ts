...
export type BackgroundJobReportResponseModel = {
    monitoringSince: string;
    jobs: Array<BackgroundJobResponseModel>;
};

export type BackgroundJobResponseModel = {
    name: string;
    typeName: string;
    kind: string;
    state: string;
...
export type DocumentVariantStateModel = 'NotCreated' | 'Draft' | 'Published' | 'PublishedPendingChanges' | 'Trashed';
...
export type RuntimeLevelModel = 'BootFailed' | 'Unknown' | 'Boot' | 'Install' | 'Upgrade' | 'Upgrading' | 'Run';
...
export type TreeItemKindModel = 'Item' | 'Folder' | 'All';
...
export type UserStateModel = 'All' | 'Active' | 'Disabled' | 'LockedOut' | 'Invited' | 'Inactive';
...
export type GetBackgroundJobsResponses = {
     ...
     * OK
     */
    200: BackgroundJobReportResponseModel;
};
